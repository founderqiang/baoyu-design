...
For thorough or directed checks ("screenshot and check the spacing"), spawn a verification subagent only when your harness reference says one is available and the user has asked for that level of verification. Otherwise, do the browser check yourself.
